...
export const PROVIDER_DEFAULTS: Record<ProviderType, ProviderDefaults> = {
  ...
  google: {
    ...
    authKind: 'api_key',
    backendKind: 'ai-sdk',
    fallbackModels: ['gemini-3.5-flash', 'gemini-3.1-pro-preview', 'gemini-2.5-pro', 'gemini-2.5-flash'],
    status: 'ready',
    protocol: 'google',
    category: 'overseas',
    catalogBadge: 'API',
  ...
  'codex-subscription': {
    ...
    authKind: 'oauth_token',
    backendKind: 'ai-sdk',
    fallbackModels: ['gpt-5.5', 'gpt-5.5-pro', 'gpt-5.4', 'gpt-5.4-mini', 'gpt-5.3-codex-spark'],
    status: 'phase3-experimental',
    protocol: 'openai',
    category: 'oauth',
